...
若选择后仍为空，可打开“管理 > 诊断中心”，复制诊断信息或生成客户反馈包。详细说明见 [首次启动与数据目录选择说明](docs/首次启动与数据目录选择说明.md)。

## 用户操作手册

完整中文操作手册已提供 Markdown、DOCX 和 PDF 三种格式，适合用户培训、项目交付、验收和日常使用参考：

- [Codex历史管理器用户操作手册.md](docs/用户操作手册/Codex历史管理器用户操作手册.md)
- [Codex历史管理器用户操作手册.docx](docs/用户操作手册/Codex历史管理器用户操作手册.docx)
- [Codex历史管理器用户操作手册.pdf](docs/用户操作手册/Codex历史管理器用户操作手册.pdf)
